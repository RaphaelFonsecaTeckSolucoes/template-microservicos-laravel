...
return [
    ...
    'description' => 'Essa documentação visa fornecer todas as informações necessárias para trabalhar com nossa API.',
    ...
    'groups' => [
        ...
        // Note: 'order' does not work for `external` docs types
        'order' => [],
    ],
